                        ...
                        <form method="POST" class="p-2" action="<?php echo e(route('admin.login')); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input id="username" type="username" class="form-control" name="username"
                                    value="<?php echo e(old('username')); ?>" tabindex="1" placeholder="Enter Username" required>
                            </div>
                            <div class="form-group">
                                <div class="d-block">
...
<?php echo $__env->make('backend.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\invest4sale\core\resources\views/backend/auth/login.blade.php ENDPATH**/ ?>