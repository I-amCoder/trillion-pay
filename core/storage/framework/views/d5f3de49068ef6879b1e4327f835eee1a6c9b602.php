            ...
            <div class="col-xxl-6">
                <div class="d-box-one h-100">
                    ...
                    <div class="content">
                        ...
                        <button class="btn btn-outline-dark text-white withdraw_now" data-wallet_type="profit_balance" data-href="<?php echo e(route('user.wallet.profit_transfer')); ?>">Transfer to main balance </button>
                    </div>
                ...
                <div class="card finance-card bg-1">
                    ...
                    <div class="card-body finance-card-body">
                        ...
                        <div class="text-center finance-buttons">
                            <button class="btn btn-success deposit_now" data-href="<?php echo e(route('user.paynow', $gateway->id)); ?>"
                                data-wallet_type="current_wallet" data-id="<?php echo e($gateway->id); ?>">Deposit</button>
                ...
                <div class="card  finance-card bg-1">
                    ...
                    <div class="card-body finance-card-body">
                        ...
                        <div class="text-center finance-buttons">
                            ...
                            <a href="<?php echo e(route('user.invest.log')); ?>" class="btn btn-danger ml-2">Invest Logs</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="sp-referral">
                                <li class="single-child root-child">
                                    <p>
                                        ...
                                        <span
                                            class="mb-0"><?php echo e(auth()->user()->full_name); ?></span>
                                    </p>
                                        ...
                                        <?php $__currentLoopData = $reference; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="single-child">
                                                <p>
                                                    ...
                                                    <span
                                                        class="mb-0"><?php echo e($user->full_name); ?></span>
                                                </p>
                                                    ...
                                                    <?php $__currentLoopData = $user->refferals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="single-child">
                                                            <p>
                                                                ...
                                                                <span
                                                                    class="mb-0"><?php echo e($ref->full_name); ?></span>
                                                            </p>
