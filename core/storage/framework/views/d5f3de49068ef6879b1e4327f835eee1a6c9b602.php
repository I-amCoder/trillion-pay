                ...
                <div class="d-box-one h-100">
                    ...
                    <div class="content">
                        ...
                        <div class="d-flex flex-wrap">
                            <a class="btn btn-outline-light m-2" href="<?php echo e(route('user.transfer_money')); ?>">Transfer
                                Money</a>
                            <a class="btn btn-outline-light m-2" href="<?php echo e(route('user.withdraw')); ?>">Withdraw</a>
                        </div>
                    </div>
                    ...
                    <div class="card-body finance-card-body">
                        ...
                        <p class="text-center finance-timer">Pending Transfer:
                            ...
                            <?php if($current_transfer): ?>
                                <?php echo e(number_format($current_transfer->amount, 3)); ?>
                    ...
                    <div class="card-body finance-card-body">
                        ...
                        <p class="text-center finance-timer">Pending Transfer:
                            ...
                            <?php if($saving_transfer): ?>
                                <?php echo e(number_format($saving_transfer->amount, 3)); ?>
                        ...
                        <div class="text-center finance-buttons">
                            <button class="btn btn-outline-light deposit_now"
                                data-href="<?php echo e(route('user.paynow', $gateway->id ?? 0)); ?>"
                                data-wallet_type="saving_wallet" data-id="<?php echo e($gateway->id ?? 0); ?>">Deposit</button>
                ...
                <div class="card  finance-card bg-1">
                    ...
                    <div class="card-body finance-card-body">
                        ...
                        <div class="text-center finance-buttons ">
                            <button class="btn btn-outline-light deposit_now"
                                data-href="<?php echo e(route('user.paynow', $gateway->id ?? 0)); ?>"
                                data-wallet_type="sharing_wallet" data-id="<?php echo e($gateway->id ?? 0); ?>">Deposit</button>
                            <button class="btn btn-outline-light ml-2 withdraw_now"
