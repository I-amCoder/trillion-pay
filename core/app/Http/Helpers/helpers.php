...
function refferMoney($id, $user, $refferal_type, $amount, $wallet_type = null)
{
    ...
    for ($i = 0; $i < $counter; $i++) {
        ...
        if ($user) {
            ...
            $user->profit_balance = $user->profit_balance + $comission;
            ...
            $a = RefferedCommission::create([
                ...
                'amount' => $comission,
                'purpouse' => $refferal_type === 'invest' ? $wallet.' invest commission' : $wallet.' Commission'
