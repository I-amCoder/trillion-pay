            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-2">
                                    ...
                                    <tbody>
                                        @forelse ($businessPackPlans as $plan)
                                            <tr>
                                                ...
                                                <td class="text-uppercase">{{ str_replace("_"," ",$plan->plan_wallet) }}</td>
                                                <td>
                        ...
                        @if ($businessPackPlans->hasPages())
                            <div class="card-footer">
                                {{ $businessPackPlans->links('backend.partial.paginate') }}
                            </div>
                        @endif
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-2">
                                    ...
                                    <tbody>
                                        @forelse ($businessValuePlans as $plan)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $plan->plan_name }}</td>
                                                <td>
                        ...
                        @if ($businessValuePlans->hasPages())
                            <div class="card-footer">
                                {{ $businessValuePlans->links('backend.partial.paginate') }}
                            </div>
                        @endif
