                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.plan.update', $plan->id) }}">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label class="font-weight-bold">{{ __('Wallet') }} <span
                                                class="text-danger">*</span></label></label>
                                        <select name="wallet" class="form-control selectric" id="wallet">
                                            <option value="0" {{ $plan->plan_wallet == "business_pack_wallets"?"selected":"" }}>{{ __('Business Pack Wallet') }}</option>
                                            <option value="1" {{ $plan->plan_wallet == "business_value_wallets"?"selected":"" }}>{{ __('Business Value Wallet') }}</option>
                                        </select>
