    ...
    <section class="auth-section">
        <div class="auth-wrapper">
            <div class="auth-top-part">
                ...
                <p class="mb-0"><span class="me-2">{{ __('Haven\'t an Account?') }}</span> <a class="cmn-btn btn-sm"
                        href="{{ route('user.register') }}">{{ __('Register') }}</a></p>
            </div>
            <div class="auth-body-part">
                <div class="auth-form-wrapper">
                    ...
                    <form action="" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="formGroupExampleInput">{{ __('Username') }}</label>
                            <input type="text" class="form-control" name="username" value="{{ old('username') }}"
                                id="username" placeholder="{{ __('Enter Your Username') }}">
                        </div>
                        <div class="mb-3">
