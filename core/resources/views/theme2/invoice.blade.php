...
<body>
    <div id="invoice" class="container">
        ...
        <div class="invoice-item">
            ...
            <span class="invoice-value">{{ $data['Trx'] }}</span>
        </div>

        <div class="invoice-item">
            <span class="invoice-label">User:</span>
            <span class="invoice-value">{{ $data['User'] }}</span>
        </div>

        <div class="invoice-item">
            <span class="invoice-label">Gateway:</span>
            <span class="invoice-value">{{ $data['Gateway'] }}</span>
        </div>
        ...
        <div class="invoice-item">
            ...
            <span class="invoice-value">{{ $data['Currency'] }}</span>
        </div>

        <div class="invoice-item">
            <span class="invoice-label">Charge:</span>
            <span class="invoice-value">{{ $data['Charge'] }}</span>
        </div>

        <div class="invoice-item">
            <span class="invoice-label">Payment Date:</span>
            <span class="invoice-value">{{ $data['PaymentDate'] }}</span>
        </div>
        <div class="image">
